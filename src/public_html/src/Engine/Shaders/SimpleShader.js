...
function SimpleShader(vertexShaderPath, fragmentShaderPath) {
   ...
   // window.alert("Creating the reference to the gl attrib location in SimpleShader after creating\n\
     //a FileTexture shader.");
...
SimpleShader.prototype.deactivateShader = function () {
  var gl = gEngine.Core.getGL();
